...
func (c *Client) ZGetOperationResultAsync(operationid string) FutureZGetOperationResultResult {
	cmd := zcashjson.NewZGetOperationResultCmd(operationid, nil)
	return c.sendCmd(cmd)
}

// ZGetOperationResult returns detailed information about a wallet transaction.
func (c *Client) ZGetOperationResult(operationid string) ([]zcashjson.ZGetOperationStatusResult, error) {
	return c.ZGetOperationResultAsync(operationid).Receive()
}
